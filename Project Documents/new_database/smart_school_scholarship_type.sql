...
LOCK TABLES `scholarship_type` WRITE;
/*!40000 ALTER TABLE `scholarship_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `scholarship_type` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-06-05  0:36:33
